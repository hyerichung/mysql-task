...
## ✨ 배포링크
#### ec2-54-180-135-200.ap-northeast-2.compute.amazonaws.com
   ---
## ✨  Introduction
...
---
## ✨ TO-DO
* 현재 MySQL에 데이터를 저장하는 방식은, s3에 수동으로 업로드 한 음원 파일, 앨범 커버 사진의 객체 URL를 이용해 앨범/트랙 목데이터 json을 만들고, MySQL과 노드가 연결될 시 해당 데이터를 함께 업로드 해줍니다
